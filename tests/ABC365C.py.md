...
data:
  ...
  code: "r\"\"\"\n ______________________\n< it's hidehico's code >\n ----------------------\n\
    ...
    \n\ndef check(mid):\n    t = 0\n    for a in A:\n        t += min(mid, a)\n\n\
    \    if t <= M:\n        return True\n    else:\n        return False\n\n\nans\
    \ = binary_search(check, 1 << 63, 0)\n\nif ans == 1 << 63:\n    print(\"infinite\"\
    )\nelse:\n    print(ans)\n"
  dependsOn: []
  isVerificationFile: false
  path: tests/ABC365C.py
  requiredBy: []
  timestamp: '1970-01-01 00:00:00+00:00'
  verificationStatus: LIBRARY_NO_TESTS
  verifiedWith: []
documentation_of: tests/ABC365C.py
layout: document
redirect_from:
- /library/tests/ABC365C.py
- /library/tests/ABC365C.py.html
title: tests/ABC365C.py
---
