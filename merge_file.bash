...
for file_name in "import.py" "standard_input.py" "math_func.py" "matrix.py" "array_create.py" "binary_search.py" "change_minmax.py" "modint.py" "yn_func.py" "grid.py" "coordinates_to_id.py" "dijkstra.py" "get_path.py" "dp.py" "coordinate_compression.py" "memo.py" "rerooting.py" "manacher.py" "rollinghash.py" "graph.py" "unionfind.py" "euler_tour.py" "potential_unionfind.py" "heap.py" "trie.py" "mo.py" "square-division.py" "prefix_sum_2d.py" "imos_2d.py" "dual_segtree.py" "dis_lib.py" "alias.py" "utils.py"; do
